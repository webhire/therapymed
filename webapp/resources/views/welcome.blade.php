                ...
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 text-lg leading-7 font-semibold"><a
                                href="https://github.com/webhire/therapymed/blob/main/LICENSE" target="_blank"
                                class="underline text-gray-900 dark:text-white">Web App License</a></div>
                    </div>

                    <div class="ml-12">
                        <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                            <p>The Therapy Med web application is open-sourced software licensed under the MIT
                                license.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 text-lg leading-7 font-semibold"><a href="https://laracasts.com"
                                                                             class="underline text-gray-900 dark:text-white">GitHub
                                page</a></div>
                    </div>

                    <div class="ml-12">
                        <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                            <p>Therapy Med has its official GitHub page to inform latest changes.</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="flex justify-center mt-4 sm:items-center sm:justify-between">
            <div class="text-center text-sm text-gray-500 sm:text-left">
                <div class="flex items-center">
                    ...
                    <a href="https://github.com/webhire" target="_blank" class="ml-1 underline">
                        Developing by WebHire
                    </a>
                </div>
            </div>
