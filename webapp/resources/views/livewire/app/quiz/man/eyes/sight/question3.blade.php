    ...
    <div class="question ml-sm-5 pl-sm-5 pt-2 animate-quiz">
        ...
        <div class="d-flex align-items-center pt-3 justify-content-evenly">
            <div class="ml-auto mr-sm-5">
                <button class="btn btn-outline-success" data-bs-toggle="modal" data-bs-target="#modal12">Ha</button>
        ...
        @if($question3 === false)
            <livewire:app.quiz.man.eyes.sight.question4 />
        @endif
    </div>
    <livewire:app.quiz.answers.modal12 />
</div>
