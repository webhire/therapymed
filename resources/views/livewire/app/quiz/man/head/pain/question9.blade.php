    ...
    <div class="question ml-sm-5 pl-sm-5 pt-2 animate-quiz">
        ...
        <div class="d-flex align-items-center pt-3 justify-content-evenly">
            <div class="ml-auto mr-sm-5">
                <button class="btn btn-outline-success" data-bs-toggle="modal" data-bs-target="#modal29">Ha</button>
        ...
        @if($question9 === false)
            <livewire:app.quiz.man.head.pain.question10 />
        @endif
    </div>
    <livewire:app.quiz.answers.modal29 />
</div>
