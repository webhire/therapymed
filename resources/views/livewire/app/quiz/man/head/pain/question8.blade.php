    ...
    <div class="question ml-sm-5 pl-sm-5 pt-2 animate-quiz">
        ...
        <div class="d-flex align-items-center pt-3 justify-content-evenly">
            <div class="ml-auto mr-sm-5">
                <button class="btn btn-outline-success" data-bs-toggle="modal" data-bs-target="#modal28">Ha</button>
                <button wire:loading.remove wire:click="$set('question8', false)" class="btn btn-outline-danger">Yoq</button>
        ...
        @if($question8 === false)
            <livewire:app.quiz.man.head.pain.question9 />
        @endif
    </div>
    <livewire:app.quiz.answers.modal28 />
</div>
