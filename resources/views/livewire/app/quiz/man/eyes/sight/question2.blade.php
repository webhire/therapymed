    ...
    <div class="question ml-sm-5 pl-sm-5 pt-2 animate-quiz">
        ...
        <div class="d-flex align-items-center pt-3 justify-content-evenly">
            <div class="ml-auto mr-sm-5">
                <button wire:loading.remove wire:click="$set('question2', true)" class="btn btn-outline-success">Ha</button>
                <button wire:loading.remove wire:click="$set('question2', false)" class="btn btn-outline-danger">Yoq</button>
        ...
        @if($question2 === true)
                    <livewire:app.quiz.man.eyes.sight.question3 />
            @elseif($question2 === false)
                <livewire:app.quiz.man.eyes.sight.question7 />
            @endif
    </div>
</div>
