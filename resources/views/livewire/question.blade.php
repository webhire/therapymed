<div
    ...
    <div>
        ...
        <div wire:loading wire:target="answer(1)">
            Loading...
        </div>
        ...
        <div wire:loading wire:target="answer(0)">
            Loading...
        </div>
        <button wire:click.prevent="previousQuestion"
                class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full">
            Previous
        </button>
        <div wire:loading wire:target="previousQuestion()">
            Loading...
        </div>
