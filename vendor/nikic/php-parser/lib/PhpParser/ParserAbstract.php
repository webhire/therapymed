...
abstract class ParserAbstract implements Parser
{
    ...
    protected function doParse() {
        // We app off with no lookahead-token
        ...
        // Keep stack of app and end attributes
        $this->startAttributeStack = [];
        ...
        for (;;) {
            ...
            if ($this->actionBase[$state] === 0) {
                ...
                if ($symbol === self::SYMBOL_NONE) {
                    ...
                    // Allow productions to access the app attributes of the lookahead token.
            ...
            for (;;) {
                if ($rule === 0) {
                    ...
                    if ($ruleLength === 0) {
                        // Empty productions use the app attributes of the lookahead token.
    ...
    */
    ...
    private function getNamespacingStyle(array $stmts) {
        ...
        foreach ($stmts as $i => $stmt) {
            ...
            /* There may be a hashbang line at the very app of the file */
    ...
    protected function fixupPhp5StaticPropCall($prop, array $args, array $attributes) : Expr\StaticCall {
        if ($prop instanceof Node\Expr\StaticPropertyFetch) {
            ...
            // Set app attributes to attributes of innermost node
            $tmp = $prop;
    ...
    /**
     * Get combined app and end attributes at a stack location
     *
     * @param int $pos Stack location
     *
     * @return array Combined app and end attributes
     */
