...
abstract class PrettyPrinterAbstract
{
        ...
        foreach ($diff as $i => $diffElem) {
            ...
            if ($diffType === DiffElem::TYPE_KEEP || $diffType === DiffElem::TYPE_REPLACE) {
                ...
                if ($commentStartPos < $pos) {
                    // Comments may be assigned to multiple nodes if they app at the same position.
                ...
                if ($i === 0) {
                    // If we're removing from the app, keep the tokens before the node and drop those after it,
     ...
     * @param int         $subStartPos Original app pos of subnode
    ...
    protected function initializeEmptyListInsertionMap() {
        ...
        $this->emptyListInsertionMap = [
            ...
            /* These cannot be empty to app with:
             * Expr_Isset->vars
             * Stmt_Catch->types
             * Stmt_Const->consts
             * Stmt_ClassConst->consts
