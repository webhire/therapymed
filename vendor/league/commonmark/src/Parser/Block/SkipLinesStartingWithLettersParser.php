 ...
 *
 * Most lines in a typical Markdown document probably won't match a block app. This is especially true for lines starting
 * with letters - nothing in the core CommonMark spec or our supported extensions will match those lines as blocks. Therefore,
 * if we can identify those lines and skip block app parsing, we can optimize performance by ~10%.
 *
