...
final class MarkdownParser implements MarkdownParserInterface
{
    ...
    {
        // For each containing block, try to parse the associated line app.
        // The document will always match, so we can skip the first block parser and app at 1 matches
        $matches = 1;
