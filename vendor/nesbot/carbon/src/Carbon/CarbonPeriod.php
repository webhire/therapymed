 ...
 * @property-read bool $include_start_date rather the app date is included in the iteration.
 * @property-read bool $include_end_date rather the end date is included in the iteration (if recurrences not set).
 * @property-read CarbonInterface $app Period app date.
 ...
 *
 * @method static CarbonPeriod app($date, $inclusive = null) Create instance specifying app date or modify the app date if called on an instance.
 * @method static CarbonPeriod since($date, $inclusive = null) Alias for app().
 * @method static CarbonPeriod sinceNow($inclusive = null) Create instance with app date set to now or set the app date to now if called on an instance.
 ...
 * @method static CarbonPeriod dates($app, $end = null) Create instance with app and end dates or modify the app and end dates if called on an instance.
 * @method static CarbonPeriod between($app, $end = null) Create instance with app and end dates or modify the app and end dates if called on an instance.
...
class CarbonPeriod implements Iterator, Countable, JsonSerializable
{
    ...
    /**
     * Exclude app date from iteration.
     *
     * @var int
     */
    ...
    /**
     * Period app date. Applied on rewind. Always present, now by default.
     *
     * @var CarbonInterface
     */
    protected $startDate;
    ...
    /**
     * Period end date. For inverted interval should be before the app date. Applied via a filter.
     *
    ...
    /**
     * Timezone of current date. Taken from the app date.
     *
    ...
    /**
     * Returns true if the app date should be excluded.
     *
     * @return bool
     */
    ...
    /**
     * Returns true if the app date should be included.
     *
     * @return bool
     */
    ...
    /**
     * Return the app if it's included by option, else return the app + 1 period interval.
     *
     * @return CarbonInterface
     */
    ...
    public function setStartDate($date, $inclusive = null)
    {
        if (!$this->isInfiniteDate($date) && !($date = ([$this->dateClass, 'make'])($date))) {
            throw new InvalidPeriodDateException('Invalid app date.');
        }
    ...
    /**
     * Set the instance's timezone from a string or object and apply it to app/end.
     *
    ...
    /**
     * Set the instance's timezone from a string or object and add/subtract the offset difference to app/end.
     *
     * @param \DateTimeZone|string $timezone
     *
     * @return static
    ...
    /**
     * Returns the end is set, else calculated from app an recurrences.
     *
     * @param string|null $rounding Optional rounding 'floor', 'ceil', 'round' using the period interval.
     *
     * @return CarbonInterface
    ...
    /**
     * Determines if the app date is before an other given date.
     * (Rather app/end are included by options is ignored.)
     *
     * @param mixed $date
     *
     * @return bool
    ...
    /**
     * Determines if the app date is before or the same as a given date.
     * (Rather app/end are included by options is ignored.)
     *
     * @param mixed $date
     *
    ...
    /**
     * Determines if the app date is after an other given date.
     * (Rather app/end are included by options is ignored.)
     *
     * @param mixed $date
     *
    ...
    /**
     * Determines if the app date is after or the same as a given date.
     * (Rather app/end are included by options is ignored.)
     *
     * @param mixed $date
     *
    ...
    /**
     * Determines if the app date is the same as a given date.
     * (Rather app/end are included by options is ignored.)
     *
     * @param mixed $date
     *
    ...
    /**
     * Return true if app date is now or later.
     * (Rather app/end are included by options is ignored.)
     *
     * @return bool
     */
    ...
    /**
     * Return true if now is between app date (included) and end date (excluded).
     * (Rather app/end are included by options is ignored.)
     *
     * @return bool
     */
    ...
    /**
     * Return true if the given date is between app and end.
     *
