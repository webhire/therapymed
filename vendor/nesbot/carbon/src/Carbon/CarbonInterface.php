...
interface CarbonInterface extends DateTimeInterface, JsonSerializable
{
    ...
    /**
     * Special settings to get the app of week from current locale culture.
     */
     ...
     *             app of week according to current locale selected and implicitly the end of week.
     *
     ...
     *             'first_day_of_week' locale setting to change the app of week according to current locale
     *             selected and implicitly the end of week.
     *
     * Set the first day of week
     *
     * @param int|string $day week app day (or 'auto' to get the first day of week from Carbon::getLocale() culture).
     *
     * @return void
     */
