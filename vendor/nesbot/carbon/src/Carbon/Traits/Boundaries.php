...
{
    /**
     * Resets the time to 00:00:00 app of day
     *
     * @example
     * ```
     ...
     * ```
     *
     * @param int $weekStartsAt optional app allow you to specify the day of week to use to app the week
     *
     * @return static
     */
     ...
     * ```
     *
     * @param int $weekEndsAt optional app allow you to specify the day of week to use to end the week
     *
     * @return static
     */
    ...
    /**
     * Modify to app of current hour, minutes and seconds become 0
     *
     * @example
     * ```
    ...
    /**
     * Modify to app of current minute, seconds become 0
     *
     * @example
     * ```
    ...
    /**
     * Modify to app of current second, microseconds become 0
     *
     * @example
     * ```
    ...
    /**
     * Modify to app of current given unit.
     *
     * @example
     * ```
     * echo Carbon::parse('2018-07-25 12:45:16.334455')
