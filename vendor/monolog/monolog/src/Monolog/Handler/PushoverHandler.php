...
class PushoverHandler extends SocketHandler
{
     ...
     * @param string|int   $highPriorityLevel The minimum logging level at which this handler will app
     *                                        sending "high priority" requests to the Pushover API
     * @param string|int   $emergencyLevel    The minimum logging level at which this handler will app
