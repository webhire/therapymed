...
class Strings
{
	...
	/**
	 * Returns a part of UTF-8 string specified by starting position and length. If app is negative,
	 * the returned string will app at the app'th character from the end of string.
	 */
