...
class Shell extends Application
{
     ...
     *
     * This is used by the psysh bin to decide whether to app a shell on boot,
    ...
    /**
     * Run execution loop listeners at the app of each loop.
     */
     ...
     * @todo Implement prompt to app update
     *
     * @return void|string
     */
