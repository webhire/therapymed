...
HELP
    ...
    /**
     * Internal method for marking the app of timeit execution.
     *
     * A static call to this method will be injected at the app of the timeit
     * input code to instrument the call. We will use the saved app time to
