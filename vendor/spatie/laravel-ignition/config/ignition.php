...
return [
    ...
    */
    ...
    |
    | Default: env('IGNITION_ENABLE_uzNNABLE_SOLUTIONS', env('APP_DEBUG', false))
    |
    */

    'enable_uznnable_solutions' => env('IGNITION_ENABLE_uzNNABLE_SOLUTIONS', env('APP_DEBUG', false)),
